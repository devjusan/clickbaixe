...
const Privacy: NextPage = () => (
  <>
    <Head>
      <title>Privacidade | CLICKBAIXE </title>
      <meta
        name="description"
    ...
    <StyledContainer>
      <StyledPost>
        ...
        <p>
          A sua privacidade é importante para nós. É política do CLICKBAIXE
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site <Link href="/">CLICKBAIXE</Link>, e outros
          sites que possuímos e operamos.
        </p>
        <p>
          Solicitamos informações pessoais apenas quando realmente precisamos
          delas para lhe fornecer um serviço. E fazemos isto por meios justos e
          legais, com o seu conhecimento e consentimento. Também informamos o
          porquê estamos coletando e como será usado.
        </p>
        <p>
      ...
      <StyledPost>
        ...
        <StyledSubtitle type="h2">Cookies de terceiros</StyledSubtitle>
        <p>
        ...
        <p>
          Para mais informações sobre cookies do{` `}
          <strong> Google Analytics</strong>, consulte a página oficial do
          Google Analytics.
        </p>
        <p>
      ...
      <StyledPost>
        <StyledSubtitle type="h2">Compromisso do Usuário</StyledSubtitle>
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o CLICKBAIXE oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do CLICKBAIXE, de seus fornecedores ou terceiros, para
      ...
      <StyledPost>
        ...
        <p>
          Esta política é efetiva a partir de <strong>May/2022</strong>.
        </p>
      </StyledPost>
    </StyledContainer>
  </>
